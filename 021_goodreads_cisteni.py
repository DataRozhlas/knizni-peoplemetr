...
df = df[df['GR_published'].str.contains("2023",na=False) | df['GR_published'].str.contains("2024",na=False)]
...
df.to_csv(os.path.join("data","goodreads-hodnoceni.csv"), index=False, encoding="utf-8", header=True)
