...
print(
    "Vybírám ze souboru cnb_vyber.parquet novinky pro sledování na Goodreads a Databázi knih."
)
...
with open(
    os.path.join("data_raw", "cnb_sledovat.json"), "w+", encoding="utf-8"
) as sledovat:
